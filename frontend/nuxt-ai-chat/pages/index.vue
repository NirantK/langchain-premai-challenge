...
<template>
	<div class="max-w-xl mx-auto text-black">
		...
		<h1 class="my-8 text-5xl font-bold text-center text-black">Recipe AI Chatbot</h1>
								...
								<div v-if="message.message.result">
									...
									<div v-if="message.message.source_documents">
										<div v-for="document in message.message.source_documents">
											...
											<p>Image<img :src="`http://3.91.215.30:3000/images/${document.metadata.image}`"></p>
										</div>
									</div>
								</div>
								<div v-else>
		...
		<div class="flex flex-col justify-center w-full my-4">
			...
			<div class="flex flex-col items-center justify-center">
				...
				<a
					href="https://github.com/NirantK/langchain-premai-challenge"
					class="flex items-center font-medium underline transition-colors underline-offset-4 hover:text-black/70"
				>
